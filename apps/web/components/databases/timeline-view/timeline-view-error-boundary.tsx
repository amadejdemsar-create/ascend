...
/**
 * DZ-7 mitigation: error boundary that wraps the database timeline view.
 *
 * If the timeline throws during render (stale data shape, drag crash, etc.),
...
export class TimelineViewErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo): void {
    console.error("[TimelineView] Error boundary caught:", error, errorInfo);
  }
