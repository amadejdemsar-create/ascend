/**
 * Gamification constants and level math.
 *
 * Platform-agnostic: used by the service layer (XP awards), dashboard
 * (progress bar), and future native clients (level display).
 */
...
// XP values per horizon (used in gamification, defined here for schema consistency)
